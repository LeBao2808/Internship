  ...
  return (
    <div className="flex justify-center  min-h-screen bg-gray-100 pt-12">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md h-64">
        <h2 className="text-2xl font-bold mb-6 text-center text-blue-600">Thông tin chi tiết User</h2>
        ...
        <div className="mb-4">
          ...
          <span className="ml-2 text-gray-900">{session.data?.user?.email}</span>
        </div>
